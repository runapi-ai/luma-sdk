...
import ai.runapi.luma.types.ModifyVideoResponse;
    ...
    class LumaLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/luma/modify_video", this::handleRequest);
        server.start();
      }
      ...
      CompletedModifyVideoResponse response =
        ...
        assertEquals("/api/v1/luma/modify_video", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/luma/modify_video/task_local_123", captured.path);
